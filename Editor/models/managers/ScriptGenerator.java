...
public class ScriptGenerator {
	/**
	 * Generates tcl scripts for ns2
	 * @param project the project that scripts will be generated
	 * @param path path of generated files
	...
	public static String genTclClass(String type) {
		if (type == null) return "";

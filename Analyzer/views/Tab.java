...
public abstract class Tab {
	...
	*/
	protected void createChildWidgets() {
		...
		exportToExcel.setText("Export Data");
	...
	*/
	protected void createLayout() {
		...
		exportImage.setText("Export to Image");
		...
		changeInfoGraph.setText("Graph Properties");
	...
	*/
	void createLayoutGroup() {
		...
		loadNeighborFile.setText("Load new neighbors file");
	...
	*/
	protected abstract void disposeEditors();
	
	/**
	* Returns the layout data field names. Subclasses override this method.
	*/
	protected abstract String[] getLayoutDataFieldNames();
	...
	*/
	protected abstract void setLayoutState();
}
